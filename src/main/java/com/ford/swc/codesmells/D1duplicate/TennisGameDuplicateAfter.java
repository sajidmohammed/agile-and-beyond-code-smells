package com.ford.swc.codesmells.D1duplicate;

import com.ford.swc.codesmells.TennisGame;

public class TennisGameDuplicateAfter implements TennisGame {
    private int player1Points = 0;
    private int player2Points = 0;
    private static final String PLAYER_1_NAME = "player1";
    private static final String PLAYER_2_NAME = "player2";

    public TennisGameDuplicateAfter(String player1Name, String player2Name) {
    }
    ...
    public String getScore() {
        ...
        if (pointsAreTied(player1Points, player2Points) && pointsAreAtMost3(player1Points)) {
            score = mapPointsToScore(player1Points) + "-All";
        }
    ...
    private String buildRegularScore(int player1Points, int player2Points) {
        String player1Score = mapPointsToScore(player1Points);
        String player2Score = mapPointsToScore(player2Points);
